// Editorjs のプラグイン simple-image-editorjs で、inputが残ってかつformで保存できるように name='image' を付与　
// https://github.com/PaulKinlan/simple-image/blob/master/example/index.html
...
class SimpleImage {
  ...
  //  元ある処理のオーバーラップ。自動サニタイズ（怪しいタグなどを削除）
  /**
   * Sanitizer rules
   */
  static get sanitize() {
  ...
  //  点メニューに追加する処理（renderSettings）のオーバーラップ
  /**
  ...
  // 点メニューの左ボタンの処理。classをtoggle。3つのボタンいずれも同じ 1/2
  /**
  ...
  // 点メニューの左ボタンの処理。classをtoggle。3つのボタンいずれも同じ 2/2
  /**
